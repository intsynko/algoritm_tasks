...
7. [Задача](./prefix_sum.py) на поиск подмножества в массиве которое дает в сумме target
8. [Задача](./find_k_closest.py) на поиск k ближайших по значению чисел
...
3. [Задача](./is_vert_sym.py) возможно ли провести вертикальную ось через группу точек поделив их на две симметричные друг другу группы
